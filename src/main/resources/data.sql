...
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('12', 'Nguyễn Văn', 'A', 'nguyenvana@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('25', 'Nguyễn Văn', 'B', 'nguyenvanb@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('63', 'Nguyễn Thị', 'C', 'nguyenthic@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('47', 'Nguyễn Văn', 'D', 'nguyenvand@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('85', 'Nguyễn Văn', 'E', 'nguyenvane@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('36', 'Nguyễn Thị', 'F', 'nguyenthif@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('27', 'Nguyễn Thị', 'G', 'nguyenthig@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('8', 'Nguyễn Thị', 'F', 'nguyenthih@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('84', 'Nguyễn Thị', 'B', 'nguyenthib@hcmut.edu.vn') ON CONFLICT DO NOTHING;
INSERT INTO ps_person (code, first_name, last_name, email)
  VALUES ('38', 'Nguyễn Thị', 'H', 'nguyenthih@hcmut.edu.vn') ON CONFLICT DO NOTHING;
