...
',null,'2','1','{"en":" Developing A Flocking Control for a Swarm Drones","vi":" Phát triển mô hình điều khiển thiết bị bay theo cơ chế bầy đàn"}','Tìm hiểu kiến thức nền tảng về mô hình SWARM Robot (cụ thể cho drones) dựa trên báo cáo của nhóm sinh viên K16.
...
',null,'3','2','{"en":"AI-based security Deployment for Software Defined Network (SDN) on NetFPGA-SUME","vi":"Triển khai hệ thống bảo mật dựa trên AI cho mạng định nghĩa phần mềm SDN trên NetFPGA-SUME"}','Giai đoạn đề cương:
...
',null,'2','1','{"en":"Develop LoRa Mesh Simulation Environment on OMNET++","vi":"Xây dựng môi trường mô phỏng LoRa Mesh trên OMNET++"}','Tìm hiểu công cụ mô phỏng OMNET++
...
',null,'3','3','{"en":"Online Blood oxygen and ECG monitoring system.","vi":"Thiết kế và chế tạo thiết bị theo dõi Oxy máu và ECG online."}','Tìm hiểu kiến thức nền tảng về Oxy máu và ECG cơ bản.
